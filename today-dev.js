...
/******/ 	return __webpack_require__(__webpack_require__.s = "./pc/src/js/app.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var KeywordList = /** @class */ (function (_super) {
    ...
    KeywordList.prototype._resize = function () {
        ...
        var f = function () {
            ...
            _this_1.hideEff();
            resizeTime = setTimeout(_this_1.updateBubble.bind(_this_1), 100);
        };
        // 모바일일때만
        if (wrap) {
            // 팝업이 열려있지 않은 상태에서만
...
var Model = /** @class */ (function () {
    ...
    Model.prototype.update = function (path, f) {
        ...
        try {
            ...
            var isAticle_1 = path.indexOf('articleList'); //  카드리스트 요청;
...
var CARD_LINK = '//test-m.news.nate.com';
var MAIN_LINK = '//ndev.nate.com';
...
var Article = /** @class */ (function (_super) {
    ...
    Article.prototype._init = function (params) {
        var wrap = document.querySelector('.todayListWrap');
        var temp = document.createDocumentFragment();
        var todayList = document.createElement('div');
        var btn = todayList.appendChild(document.createElement('button'));
        var tit = todayList.appendChild(document.createElement('h3'));
        var todayListItem = todayList.appendChild(document.createElement('div'));
        var ul = todayListItem.appendChild(document.createElement('ul'));
    ...
    Article.prototype._update = function () {
        var todayListWrap = document.querySelector('.todayListWrap');
        ...
        this._init();
        var createNode = this.model.article.reduce(function (n, d, i) {
            var artc_title = d.artc_title, cp_nm = d.cp_nm, img_url = d.img_url, link_url = d.link_url, insert_dtm = d.insert_dtm;
    ...
    Article.prototype._addEvent = function (p) {
        var n = document.querySelector('.todayListWrap');
        var duration = .3;
...
var utils_1 = __webpack_require__(/*! ../../../components/utils */ "./components/utils.js");
var Article_1 = __webpack_require__(/*! ./Article */ "./pc/src/js/Article.ts");
var g = global;
var params = utils_1.getURIparams(window.location.search, '&');
g.params = params;
...
DATA.attachHandleError = (function () {
    var obj = {
        ...
        f: function () {
            ...
            error.innerHTML = "\n                <div class=\"eBox\">\n                    <p>" + utils_1.krStr[8] + "<br>" + utils_1.krStr[9] + "</p>\n                    <p>" + utils_1.krStr[10] + "</p>\n                    <a href=\"//" + g.window.location.host + "\" class=\"restart\">" + utils_1.krStr[11] + "</a>\n                </div>\n            ";
...
DATA.attachHandleError = (function () {
    var obj = {
        ...
        target: '.today-loader',
        f: function () {
            if (document.querySelector('.group-wrap.active'))
                return;
...
keyword.eventListner.set('b-update', function () {
    var _a = article.model.items[article.model.rank], keyword_dtm = _a.keyword_dtm, keyword_sq = _a.keyword_sq;
...
document.addEventListener('DOMContentLoaded', function () {
    var path = (history.state && history.state !== '') ? g.KEYWORD_URL + "?service_dtm=" + history.state.progress_dtm : g.KEYWORD_URL;
    // 초기화
    DATA.update(path, function () {
        var _a = DATA.items[DATA.rank], keyword_dtm = _a.keyword_dtm, keyword_sq = _a.keyword_sq;
        ...
        document.querySelector('.todayListWrap').addEventListener('click', function (e) {
            e.preventDefault();
            var t = e.target.closest('li');
            if (t) {
    ...
    window.addEventListener('scroll', function () {
        ...
        var n = document.querySelector('.btnScrollTop');
        if (!n)
            return;
        if (scrollTop > 750) {
...
/******/ });
//# sourceMappingURL=today-dev.js.map