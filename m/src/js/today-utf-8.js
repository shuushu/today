...
var newsEdge = (function() {
  ...
  bubblesController = (function controlBubbles() {
    ...
    var bubbles = {
      ...
      options: {
        ...
        color: ['rgba(19, 73, 253, .7)', 'rgba(39, 137, 252, .7)', 'rgba(24, 174, 219, .7)', 'rgba(75, 49, 230, .7)', 'rgba(73, 178, 25, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)'],
  ...
  function callArticle(d, immediate) {
    const fillColor = ['rgba(19, 73, 253, .7)', 'rgba(39, 137, 252, .7)', 'rgba(24, 174, 219, .7)', 'rgba(75, 49, 230, .7)', 'rgba(73, 178, 25, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)', 'rgba(226, 226, 226, .7)'];
    const setVal = (d, res) => {
      // 히스토리 저장
      const Datum = {
        name: 'Article',
